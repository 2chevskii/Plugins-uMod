...
namespace Oxide.Plugins
{
    ...
    public class IngameClockGUI : RustPlugin
    {
        ...
        string Replier(BasePlayer player, bool prefix, string message, params string[] args) => (prefix ? (lang.GetMessage(mprefix, this, player.UserIDString) + " " ) : string.Empty) + string.Format(lang.GetMessage(message, this, player.UserIDString), args);
        ...
        const string menabled = "Enabled clock";
        const string mdisabled = "Disabled clock";
        const string mgametime = "Clock shows game time";
        const string mservertime = "Clock shows server time";
        const string mhelp = "Help message";
        const string mrestrictedchanging = "Time choosing prevented";
